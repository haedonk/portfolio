          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            >
              ...
              <div className="overflow-hidden">
                ...
                <a href="https://linkedin.com/in/haedonkaufman" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 break-all">linkedin.com/in/haedonkaufman</a>
              </div>
            </motion.div>
          </div>
